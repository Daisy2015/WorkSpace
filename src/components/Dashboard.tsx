          ...
          <div className="max-w-7xl mx-auto px-8 py-6 flex justify-between items-end">
            <div>
              <h1 className="text-3xl font-black text-slate-900 tracking-tight mb-1">
                Jura<span className="text-indigo-600 italic">WorkSpace</span>
              </h1>
              <p className="text-slate-500 text-sm font-medium">
                {isZh ? '个人工作台' : 'Pernsonal  Hub'}
              </p>
            </div>
            
            <div className="flex items-center gap-4">
               <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-slate-50 border border-slate-100 rounded-lg text-xs font-bold text-slate-500">
