...
const Switch = React.forwardRef<HTMLButtonElement, { checked?: boolean, onCheckedChange?: (checked: boolean) => void, id?: string, className?: string }>(({ checked, onCheckedChange, id, className }, ref) => (
  <button
    type="button"
    role="switch"
