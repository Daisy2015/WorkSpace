...
import { IntelligentDocQaTopBar } from './IntelligentDocQaTopBar';
import { ProDocQaRequirementTree } from './ProDocQaRequirementTree';
import { ContractDocPreviewPane } from './ContractDocPreviewPane';
import { AssistantSidebar } from './AssistantSidebar';
import { EvidenceChainPanel } from './EvidenceChainPanel';
import { Workspace, Message, SavedOutcome, ResourceNode } from '../types';

interface IntelligentDocQaWorkspaceDetailProps {
  lang: 'zh' | 'en';
...
export const IntelligentDocQaWorkspaceDetail: React.FC<IntelligentDocQaWorkspaceDetailProps> = ({
  lang,
  activeWorkspaceId,
  activeWorkspaceData,
  currentUser,
  ...
  return (
    <div className="h-full relative flex flex-col" id="intelligent-doc-qa-workspace-detail">
      {/* Custom Top Bar */}
      <IntelligentDocQaTopBar
        lang={lang}
      ...
      <div className="flex-1 flex flex-row overflow-hidden relative">
        ...
        >
          <div className="flex-1 relative flex flex-row">
            {/* Center Area: Professional Contract Document Preview */}
            <ContractDocPreviewPane lang={lang} />
          </div>
        </motion.div>
        ...
        <AssistantSidebar
          ...
          agentName={lang === 'zh' ? '文档问答智能体' : 'Doc QA Agent'}
          agentStatus="Idle"
          mode="absolute"
          offsetTop="top-0"
